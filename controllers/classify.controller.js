...
router.put('/testUpdateMany', testUpdateMany)


module.exports = router

// middlewares
async function testUpdateMany(req, res) {
  try {
    res.tools.setJson(200, '获取成功', await classifyService.testUpdateManyClassify(req.body))
  } catch (err) {
    console.log(err)
